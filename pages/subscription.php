                ...
                <div class="row row-medium" style="align-items: flex-start">
                    <div class="column width-2-3-lg width-2-3-md width-1-1-sm" style="flex-wrap: wrap">
                        ...
                        if(isset($_POST["submit"])) {
                            ...
                            $sql = "INSERT INTO subscription (user_id, payment_method, date_time, status) VALUES (?,?,?,?)";
                            $stmt = mysqli_stmt_init($conn);
                            $prepareStmt = mysqli_stmt_prepare($stmt, $sql);

                            if ($prepareStmt) {
                                mysqli_stmt_bind_param($stmt, "ssss", $user_id, $payment_method, $date_time, $status);
                        ...
                        <form action="" method="post" onsubmit="handleSubmit()" style="width: 100%">
                            <div class="row row-medium" style="align-items: center; width: 100%">
                                <div class="column width-2-3-lg width-2-3-md width-1-1-sm" style="padding-right: 2.5px; display: none">
                                    <input name="count_of_green_points" type="text" class="form-control" id="count_of_green_points" aria-describedby="expiry_date" placeholder="Enter count of green points" value="99.9" style="margin: 5px 0; width: 100%;">
                                </div>
                            </div>
                    ...
                    <div class="column width-1-3-lg width-1-3-md width-1-1-sm">
                        <div class="block-extra" style="width: 100%">
                            <p>EcoResource subscription fee:</p>
                            <p style="font-size: 28px; font-weight: 600; color: #0B1C3F; margin-bottom: 0">£99.90</p>
                        </div>
                    </div>
                </div>
            </div>
